...
# Install GStreamer plugins and codecs using unified batch installation
...
# Handle ffmpeg conflict before batch installation
if rpm -q ffmpeg-free >/dev/null 2>&1; then
    print_info "Removing ffmpeg-free to avoid conflicts..."
    sudo $DNF_CMD remove -y ffmpeg-free >/dev/null 2>&1
fi

# Install all codec packages in batch
CODEC_PACKAGES=(
    "gstreamer1-plugins-good"
    "gstreamer1-plugins-base"
    "gstreamer1-plugin-openh264"
